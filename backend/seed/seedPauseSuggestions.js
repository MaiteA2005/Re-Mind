...
const pauseSuggestions = [
  ...
  },
  {
    ...
    methods: [
        ...
        methodOptions: [
            { label: "4-4-4-4", inhale: 4, holdAfterInhale: 4, exhale: 4, holdAfterExhale: 4 },
            { label: "5-5-5-5", inhale: 5, holdAfterInhale: 5, exhale: 5, holdAfterExhale: 5 },
            { label: "6-6-6-6", inhale: 6, holdAfterInhale: 6, exhale: 6, holdAfterExhale: 6 },
        ],
        },
        {
        id: 702,
        ...
        methodOptions: [
            { label: "5-0-5-0", inhale: 5, holdAfterInhale: 0, exhale: 5, holdAfterExhale: 0 },
            { label: "6-0-6-0", inhale: 6, holdAfterInhale: 0, exhale: 6, holdAfterExhale: 0 },
        ],
        },
        {
        id: 703,
        ...
        methodOptions: [
            { label: "2-0-4-0", inhale: 2, holdAfterInhale: 0, exhale: 4, holdAfterExhale: 0 },
            { label: "3-0-6-0", inhale: 3, holdAfterInhale: 0, exhale: 6, holdAfterExhale: 0 },
            { label: "4-0-8-0", inhale: 4, holdAfterInhale: 0, exhale: 8, holdAfterExhale: 0 },
        ],
        },
    ],
    },
